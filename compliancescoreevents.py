...
DRIVER_ID = ObjectId("6900f6a1a1d53ab328b90be8")  
...
with SSHTunnelForwarder(
    ...
    # -------- FETCH ALL COMPLIANCE SCORE EVENTS --------
    cursor = db["compliancescoreevents"].find({"driverId": DRIVER_ID}).sort("createdAt", ASCENDING)
    ...
    for rec in cursor:
        ...
        record = {
            ...
            "eventTimestamp": s.get("eventTimestamp"),
            "eventType": s.get("eventType"),
            "eventSubType": s.get("eventSubType"),
            "scoreImpact": s.get("scoreImpact"),
            "metadata": json.dumps(s.get("metadata", {}), default=str),
    ...
    df = df.fillna("")
    outname = f"compliance_score_events.csv"
